...
do_install:append() {
    ...
    install -d ${D}/${prefix_native}/share/entity-manager/configurations/
    install -m 0644 ${WORKDIR}/GC1600PMP_psu.json ${D}/${prefix_native}/share/entity-manager/configurations
...
FILES:${PN}  += "${prefix_native}/share/entity-manager/configurations/GC1600PMP_psu.json"
FILES:${PN}  += "${prefix_native}/share/entity-manager/configurations/nvme_ExAscend.json"
FILES:${PN}  += "${prefix_native}/share/entity-manager/blacklist.json"